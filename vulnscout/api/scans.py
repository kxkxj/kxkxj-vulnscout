...
from vulnscout.models.schemas import Patch, Scan, ScanResponse, ScanStatus, SourceType, Vulnerability, VulnerabilityResponse, PatchResponse
...
async def create_scan(source_type: str = "local", source_path: str = "", file: UploadFile | None = None, db: Session = Depends(get_db)):
